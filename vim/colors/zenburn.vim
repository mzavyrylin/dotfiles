...
hi Character       guifg=#dca3a3 gui=bold                     ctermfg=181 cterm=NONE
hi Comment         guifg=#7f9f7f gui=italic                   ctermfg=108
hi Conditional     guifg=#f0dfaf gui=bold                     ctermfg=223 cterm=NONE
hi Constant        guifg=#dca3a3 gui=bold                     ctermfg=181 cterm=NONE
hi Cursor          guifg=#000d18 guibg=#8faf9f gui=bold       ctermfg=233 ctermbg=109 cterm=NONE
hi Debug           guifg=#bca3a3 gui=bold                     ctermfg=181 cterm=NONE
hi Define          guifg=#ffcfaf gui=bold                     ctermfg=223 cterm=NONE
hi Delimiter       guifg=#8f8f8f                              ctermfg=245
hi DiffAdd         guifg=#709080 guibg=#313c36 gui=bold       ctermfg=66  ctermbg=237 cterm=NONE
hi DiffChange      guibg=#333333                              ctermbg=236
hi DiffDelete      guifg=#333333 guibg=#464646                ctermfg=236 ctermbg=238
hi DiffText        guifg=#ecbcbc guibg=#41363c gui=bold       ctermfg=217 ctermbg=237 cterm=NONE
hi Directory       guifg=#9fafaf gui=bold                     ctermfg=109 cterm=NONE
hi ErrorMsg        guifg=#80d4aa guibg=#2f2f2f gui=bold       ctermfg=115 ctermbg=236 cterm=NONE
hi Exception       guifg=#c3bf9f gui=bold                     ctermfg=249 cterm=NONE
...
hi MoreMsg         guifg=#ffffff gui=bold                     ctermfg=231 cterm=NONE
...
hi PreCondit       guifg=#dfaf8f gui=bold                     ctermfg=180 cterm=NONE
hi PreProc         guifg=#ffcfaf gui=bold                     ctermfg=223 cterm=NONE
hi Question        guifg=#ffffff gui=bold                     ctermfg=231 cterm=NONE
hi Repeat          guifg=#ffd7a7 gui=bold                     ctermfg=223 cterm=NONE
hi Search          guifg=#ffffe0 guibg=#284f28                ctermfg=230 ctermbg=22
hi SignColumn      guifg=#9fafaf gui=bold                     ctermfg=109 cterm=NONE
hi SpecialChar     guifg=#dca3a3 gui=bold                     ctermfg=181 cterm=NONE
hi SpecialComment  guifg=#82a282 gui=bold                     ctermfg=108 cterm=NONE
...
hi StorageClass    guifg=#c3bf9f gui=bold                     ctermfg=249 cterm=NONE
hi String          guifg=#cc9393                              ctermfg=174
hi Structure       guifg=#efefaf gui=bold                     ctermfg=229 cterm=NONE
hi Tag             guifg=#e89393 gui=bold                     ctermfg=181 cterm=NONE
hi Title           guifg=#efefef gui=bold                     ctermfg=255 ctermbg=NONE cterm=NONE
hi Todo            guifg=#dfdfdf guibg=NONE    gui=bold       ctermfg=254 ctermbg=NONE cterm=NONE
hi Typedef         guifg=#dfe4cf gui=bold                     ctermfg=253 cterm=NONE
hi Type            guifg=#dfdfbf gui=bold                     ctermfg=187 cterm=NONE
...
hi VisualNOS       guifg=#333333 guibg=#f18c96 gui=bold,underline ctermfg=236 ctermbg=210 cterm=NONE
hi WarningMsg      guifg=#ffffff guibg=#333333 gui=bold       ctermfg=231 ctermbg=236 cterm=NONE
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi PmenuSel      guibg=#353a37 guifg=#ccdc90 gui=bold  ctermfg=187 ctermbg=236 cterm=NONE
    hi MatchParen    guifg=#f0f0c0 guibg=#383838 gui=bold  ctermfg=229 ctermbg=237 cterm=NONE
    ...
    hi PmenuSel      guibg=#242424 guifg=#d0d0a0 gui=bold  ctermfg=187 ctermbg=235 cterm=NONE
    hi MatchParen    guifg=#b2b2a0 guibg=#2e2e2e gui=bold  ctermfg=145 ctermbg=236 cterm=NONE
    ...
    hi TabLineSel    guifg=#f0f0b0 guibg=#333333 gui=bold  ctermbg=236 ctermfg=229 cterm=NONE
...
if exists("g:zenburn_alternate_Error") && g:zenburn_alternate_Error
    ...
    hi Error    guifg=#e37170 guibg=#664040 gui=bold  ctermfg=210 ctermbg=52 cterm=NONE
else
    " default is something more zenburn-compatible
    hi Error    guifg=#e37170 guibg=#3d3535 gui=bold  ctermfg=167 ctermbg=236 cterm=NONE
endif

if exists("g:zenburn_alternate_Include") && g:zenburn_alternate_Include
    " original setting
    hi Include  guifg=#ffcfaf gui=bold                ctermfg=223 cterm=NONE
else
    " new, less contrasted one
    hi Include  guifg=#dfaf8f gui=bold                ctermfg=180 cterm=NONE
endif
